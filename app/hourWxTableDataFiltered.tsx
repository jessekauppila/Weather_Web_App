    ...
    const flattenedData: FormattedObservation[] = Object.values(data)
      ...
      .map(obs => {
        ...
        return {
          ...
          "Total Snow Depth": isNaN(obs.snow_depth) ? "error" : formatValueWithUnit(obs.snow_depth, "in"),
          "Error Filtered Total Snow": isNaN(obs.error_filtered_total_snow) ? "error" : formatValueWithUnit(obs.error_filtered_total_snow, "in"),
          "24h Snow Depth": isNaN(obs.snow_depth_24h) ? "error" : formatValueWithUnit(obs.snow_depth_24h, "in"),
          "Error Filtered 24hr Snow Accum": isNaN(obs.error_filtered_24hr_snow_accum) ? "error" : formatValueWithUnit(obs.error_filtered_24hr_snow_accum, "in"),
